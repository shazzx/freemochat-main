...
import { usePromotePost } from '@/hooks/Post/usePost'
...
function PostPromotionModel({ postId, setPostPromotion }) {
    ...
    return (
        <div className='fixed inset-0 z-50 w-screen  overflow-hidden h-screen flex items-center justify-center'>
            ...
            {/* delete or comment the below code when you want to use the post promotion feature  */}

            <div className='z-50 bg-card p-6 border border-accent'>
                Feature will be available soon.
            </div>

            {/* uncomment the below code when you want to use the post promotion feature  */}
