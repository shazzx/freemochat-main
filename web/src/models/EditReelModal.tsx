...
function EditReel({ setModelTrigger, createPost, editPost, postDetails, updatePost, isReel, isShared }: any) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className={`max-h-[90vh] overflow-y-auto ${(isShared && !editPost)
                ? 'max-w-[360px]'
                : 'max-w-[440px]'
                }`}>
                {/* Loading Overlay */}
