...
const CPostModal: FC<any> = ({ setModelTrigger, createPost, editPost, postDetails, updatePost }) => {
    ...
    return (
        <div className='fixed inset-0 z-50  w-screen sm:p-8 overflow-hidden h-screen flex items-center justify-center top-0 right-0'>
            ...
            <div className='relative z-10 bg-background rounded-lg w-[440px] overflow-auto border-2 border-accent'>
                ...
                <div className="p-3 h-full overflow-y-auto relative">
                    <form className="flex flex-col h-full gap-2 justify-between" onSubmit={async (e) => {
                        ...
                        <div className={`w-full ${selectedMedia?.length > 0 || postDetails?.media?.length ? 'h-[240px]' : 'h-[360px]'} flex flex-col items-center`}>
                            <textarea name="" className="w-full bg-card h-full p-2" defaultValue={editPost && postDetails?.content} placeholder="write something" id="" ref={content}>
                        ...
                        <div>
                            <div className="w-full flex flex-col items-end justify-center gap-1 ">
                                ...
                                <div className="w-full flex justify-between p-2">
                                    <span className="text-base text-center p-2 bg-card rounded-md">Visibility</span>
                                    <div>
                        ...
                        <div className="flex justify-end gap-2">
                            <Button type="button" disabled={uploading} className="bg-card" onClick={() => {
                                setModelTrigger(false)
