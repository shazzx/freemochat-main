...
export function DataTableCampaigns({ columns, data , title, filter, reverse, setReverse, refetch, handleSearchChange, fetchNextPage, useGroups, search, isLoading, setModelState, setItemIndex, filterValue }: any) {
  ...
  let groups = useGroups ? useGroups(search) : undefined
  ...
  return (
    <div className="w-ful">
      <div className="flex items-center py-4">
        <h2 className="text-lg font-medium pr-2">{title}</h2>
      ...
      <div className="rounded-md border bg-card overflow-y-scroll max-h-96">
        <Table>
          <TableHeader>
