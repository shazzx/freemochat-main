      ...
      <main className="max-w-4xl mx-auto p-6 bg-white shadow-md my-6 rounded-lg">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 leading-relaxed">
            Freemochat is committed to creating a safe, inclusive, and responsible social networking environment.
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>Freemochat is designed for users aged 13 years and above.</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            {/* <li>Freemochat does not collect, store, or share personal data of children without parental consent.</li> */}
...
{/* 
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 text-gray-700 space-y-2">
            <li>Freemochat adheres to Google Play's.</li>
