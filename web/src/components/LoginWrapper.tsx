...
export function LoginWrapper() {
  const [selectedCountryIso3, setSelectedCountryIso3] = useState("PAK");
  ...
  const onSubmit = async (data) => {
    ...
    if (isPhoneTabActive) {
      console.log(selectedCountryIso3, data.username)
        ...
        <TabsContent value="phone">
          <Card>
            ...
            <CardFooter className="flex flex-col space-y-4">
              ...
              <Button disabled={loginButtonState} type="submit" onClick={() => {
                console.log('yes')
              }} className="w-full">
                {loginButtonState ?
                  <svg className="text-gray-700 animate-spin" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg"
