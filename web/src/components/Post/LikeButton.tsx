  ...
  return (
    ...
    >
      ...
      {((!postData?.isLikedByUser) || (postData?.isLikedByUser && !postData?.reaction)) &&
        ...
        <Heart className={`w-[24px] h-[24px] sm:w-[28px] sm:h-[28px] transform scale-x-[-1] ${postData?.isLikedByUser ? 'fill-red-500 stroke-red-500' : 'stroke-foreground dark:stroke-foreground'} `} />
      }
