import { Angry, Frown, Heart, Laugh, Star, ThumbsUp } from 'lucide-react';
...
console.log(showReactions)
  ...
  return (
    ...
    <div className='relative flex gap-1 items-center cursor-pointer' onMouseDown={handleMouseDown} onMouseUp={handleMouseUp} >
        {/* <svg width="40" height="40" className={`${postData?.isLikedByUser ? 'fill-red-500 stroke-red-500' : 'stroke-foreground dark:stroke-foreground'} `} viewBox="0 0 39 38" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         {showReactions && (
        <div className="absolute bottom-full left-0 mb-2 bg-background border border-accent rounded-full shadow-lg flex">
