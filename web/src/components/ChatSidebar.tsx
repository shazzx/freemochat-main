    ...
    return (
        <div className={`min-w-[260px] sm:max-w-[460px] w-full flex h-full ${chatOpen && "hidden lg:flex"}`}>
            {searchParams.get("model") == "newgroup" &&
                <CreateChatGroup socket={socket} setCurrentTab={setCurrentTab} currentTab={currentTab} setModelTrigger={setGroupModelState} createGroup={createGroup} />
            }
            ...
            <div className='relative h-full w-full border border-muted '>
                <div className="p-5 flex items-center gap-2 font-medium text-xl pb-5">
                    <MdMessage size={28} className="text-foreground" />
                    <h2>Conversations</h2>
                </div>
                ...
                <div className="absolute bottom-4 right-4 w-12 h-12 flex items-center justify-center border-foreground text-2xl font-md" ref={newChatRef}>
                    {!chatOptions ?
                        ...
                        <MdCancel cursor="pointer" onClick={() => {
                            setChatOptions(false)
                        }} />
                    }
                </div>
                ...
                {chatOptions &&
                    <div className=" absolute bottom-14 right-2 w-[200px] bg-card" ref={newChatRef}>
